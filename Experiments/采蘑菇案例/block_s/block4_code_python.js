...
Blockly.Python['block_move'] = function(block) {
  var direction = Blockly.Python.valueToCode(block, 'direction', Blockly.JavaScript.ORDER_ATOMIC);
  var steps = Blockly.Python.valueToCode(block, 'steps', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
